...
// include: C:\Users\malte\AppData\Local\Temp\tmpswal85kf.js
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/Ball.png", "start": 0, "end": 3237}, {"filename": "/assets/Bomb.png", "start": 3237, "end": 3678}, {"filename": "/assets/Box.png", "start": 3678, "end": 3861}, {"filename": "/assets/Geele.png", "start": 3861, "end": 5167}, {"filename": "/assets/Geele_shadow.png", "start": 5167, "end": 5311}, {"filename": "/assets/README.md", "start": 5311, "end": 5474}, {"filename": "/assets/long_cat.png", "start": 5474, "end": 5657}, {"filename": "/assets/round_cat.png", "start": 5657, "end": 5974}], "remote_package_size": 5974});

  })();

// end include: C:\Users\malte\AppData\Local\Temp\tmpswal85kf.js
// include: C:\Users\malte\AppData\Local\Temp\tmpxtsgs37f.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\malte\AppData\Local\Temp\tmpxtsgs37f.js
// include: C:\Users\malte\AppData\Local\Temp\tmpqxmuir1i.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\malte\AppData\Local\Temp\tmpqxmuir1i.js
...
var ASM_CONSTS = {
  130216: () => { if (document.fullscreenElement) return 1; },  
 130262: () => { return document.getElementById('canvas').width; },  
 130314: () => { return parseInt(document.getElementById('canvas').style.width); },  
 130382: () => { document.exitFullscreen(); },  
 130409: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 130482: () => { if (document.fullscreenElement) return 1; },  
 130528: () => { return document.getElementById('canvas').width; },  
 130580: () => { return screen.width; },  
 130605: () => { document.exitFullscreen(); },  
 130632: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 130765: () => { return window.innerWidth; },  
 130791: () => { return window.innerHeight; },  
 130818: () => { if (document.fullscreenElement) return 1; },  
 130864: () => { return document.getElementById('canvas').width; },  
 130916: () => { return parseInt(document.getElementById('canvas').style.width); },  
 130984: () => { if (document.fullscreenElement) return 1; },  
 131030: () => { return document.getElementById('canvas').width; },  
 131082: () => { return screen.width; },  
 131107: () => { return window.innerWidth; },  
 131133: () => { return window.innerHeight; },  
 131160: () => { if (document.fullscreenElement) return 1; },  
 131206: () => { return document.getElementById('canvas').width; },  
 131258: () => { return screen.width; },  
 131283: () => { document.exitFullscreen(); },  
 131310: () => { if (document.fullscreenElement) return 1; },  
 131356: () => { return document.getElementById('canvas').width; },  
 131408: () => { return parseInt(document.getElementById('canvas').style.width); },  
 131476: () => { document.exitFullscreen(); },  
 131503: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 131561: () => { return screen.width; },  
 131586: () => { return screen.height; },  
 131612: () => { return window.screenX; },  
 131639: () => { return window.screenY; },  
 131666: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 131719: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 131790: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 131847: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 132103: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 132174: () => { if (document.fullscreenElement) return 1; },  
 132220: () => { return window.innerWidth; },  
 132246: () => { return window.innerHeight; },  
 132273: () => { if (document.pointerLockElement) return 1; }
};
